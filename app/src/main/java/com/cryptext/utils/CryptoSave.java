...
public class CryptoSave extends AsyncTask<Void, Integer, Boolean> {
    ...
    private final IDBForNotes dbNotes;
     ...
     */
    private CryptoSave(final IDBForNotes dbNotes, final String path, final String key, Context mContext) {
        super();
    ...
    public static class Builder {
         ...
         * @param key     password
         */
        public Builder(final IDBForNotes dbNotes, final String path, final String key, Context mContext) {
            this.dbNotes = dbNotes;
            this.path = path;
            this.key = key;
            this.mContext = mContext;
    ...
    protected Boolean doInBackground(final Void... params) {
        ...
        try {
            ...
            byte[] byteKey = Crypto.getInstance().deriveKey(key, salt);
            final SecretKeySpec secretKey = new SecretKeySpec(byteKey, "AES");
            //Creation of Cipher objects
            final byte[] iv = Crypto.getInstance().generateIv();
    ...
    protected void onPostExecute(final Boolean result) {
        ...
        if (result) {
            ...
            if (delegate != null && caller.equals("SelectDatabaseActivity")) {
                ...
                delegate.asyncComplete(DBForNotesAsync.REQUEST_CHANGE_PASSWORD);
            }
