...
public class EditNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        final String title = intent.getStringExtra(IDBForNotes.TITLE);
        final String tags = intent.getStringExtra(IDBForNotes.TAGS);
    ...
    private void saveNote() {
        ...
        final Intent intent = getIntent();
        intent.putExtra(IDBForNotes.TITLE, fieldTitle.getText().toString());
        intent.putExtra(IDBForNotes.TAGS, fieldTags.getText().toString());
